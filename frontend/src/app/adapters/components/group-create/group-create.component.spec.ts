...
describe("GroupCreateComponent", () => {
  ...
  describe("Name Validation", () => {
    it("should show error for name less than 3 characters", () => {
      ...
      const errorEl = fixture.nativeElement.querySelector(
        '[data-testid="name-minlength-error"]',
      );
    ...
    it("should not show errors for valid name", () => {
      ...
      const errorEls = fixture.nativeElement.querySelectorAll(
        '[data-testid^="name-"]',
      );
      const visibleErrors = Array.from(errorEls).filter(
  ...
  describe("Budget Validation", () => {
    ...
    it("should show required error when budget is empty and touched", () => {
      ...
      const errorEl = fixture.nativeElement.querySelector(
        '[data-testid="budget-required-error"]',
      );
      expect(errorEl).toBeTruthy();
    });
