...
describe("NotificationComponent", () => {
  ...
  describe("template rendering", () => {
    ...
    it("should apply correct class for notification type", () => {
      ...
      expect(
        notificationElements[0].classList.contains("notification-success"),
      ).toBeTrue();
      expect(
        notificationElements[1].classList.contains("notification-error"),
      ).toBeTrue();
    });
    ...
    it("should display correct icon", () => {
      const icons =
        fixture.nativeElement.querySelectorAll(".notification-icon");
